...
?>
	<div class="row go-to-page">
		<input type="text" maxlength="3"  placeholder="Go to Page" data-target="<?= $wp_query->max_num_pages ?>" data-url="<?= site_url().'/about/media-room/press-releases/page/'?>" name="go-to-page-input" width="40">
        ...
        $pages = paginate_links( array(
          ...
          if( is_array( $pages ) ) {
            ...
            <div class="go-to-page">
              ...
              <input type="text" maxlength="3" data-target="<?= $wp_query->max_num_pages ?>" data-url="<?= site_url().'/about/media-room/press-releases/page/'?>" name="go-to-page-input" width="40">
              <a class="page-numbers" href=""><div class="page-links">Go</div></a>
              <div class="error hidden">This page does not exist</div>
              <div class="error-number hidden">Please only number</div>
            </div>
