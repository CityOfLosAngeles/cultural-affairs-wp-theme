<div class="black-bg white-txt text-center" id="#subscribe">
    ...
    <?php echo do_shortcode('[ctct form="20554"]') ?>
...
<footer class="content-info">
  ...
  <div class="footer-bottom">
    <div class="container">
      <div class="col-xs-12 col-sm-7 footer-copyright">
      ...
      <div class="col-xs-12 col-sm-4 footer-kluge">
        <a title="Kluge Interactive" target="_blank" href="http://klugeinteractive.com"><div class="klugeLogo"></div></a>
      </div>
      <div class="back-top">
