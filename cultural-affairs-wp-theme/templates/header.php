      ...
      <div class="mobile-search-box">      
        <form action="/" method="get">
          <div class="input-group">
            <input type="text" name="s" id="search" value="<?php the_search_query(); ?>" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Search'" class="form-control" placeholder="Search">
...
<header id="header" class="banner navbar navbar-default">
  <div class="container">
    ...
    <div class="navbar-header">
      ...
      <?php } elseif ( is_tax('media-room-categories') || is_singular('council_district') || is_post_type_archive('council_district') ) { ?>
