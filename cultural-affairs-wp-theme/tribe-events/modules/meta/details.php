...
$start_datetime = tribe_get_start_date(null, false, 'M d, Y @ hA');
$start_date = tribe_get_start_date( null, false, 'M d, Y @ hA' );
$start_time = tribe_get_start_date( null, false, 'M d, Y @ hA' );
$start_ts = tribe_get_start_date( null, false, 'M d, Y @ hA' );

$end_datetime = tribe_get_end_date(null, false, 'M d, Y @ hA');
$end_date = tribe_get_end_date( null, false, 'M d, Y @ hA' );
$end_time = tribe_get_end_date( null, false, 'M d, Y @ hA' );
$end_ts = tribe_get_end_date( null, false, 'M d, Y @ hA' );
...
<div class="tribe-events-meta-group tribe-events-meta-group-details">
	<dl>
		...
		if ( ! empty( $cost ) ) : ?>
			...
			<dt class="with-border"> <?php esc_html_e( 'Cost', 'the-events-calendar' ) ?> </dt>
		...
		if ( ! empty( $website ) ) : ?>
			...
			<dt class="with-border"> <?php esc_html_e( 'Site', 'the-events-calendar' ) ?> </dt>
